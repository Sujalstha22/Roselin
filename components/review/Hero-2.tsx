    ...
    return (
        <>
            ...
            <section className="relative flex h-svh items-end justify-center overflow-hidden select-none bg-black p-0 pb-[17vh] xl:h-dvh xl:pb-[13vh]">
                ...
                {/* Hero Title */}
                <div className="pointer-events-none absolute inset-0 z-20 flex items-end justify-center md:items-center md:justify-start px-6 pb-12 md:pb-0 md:px-16 lg:px-24">
                    <div className="w-full max-w-[90vw] sm:max-w-[60vw] md:max-w-[30vw] lg:max-w-[25vw] text-left">
                        ...
                        <p className="mt-3 text-[3.5vw] sm:text-sm leading-relaxed text-white/85 md:text-burgundy md:text-base">
